...
- .then can return both result and error
- Can use key to unmount and re-mount component.
- use react-error-boundary
- when use status and data state separately, make sure to set status before set
  data to avoid rerender with null data
