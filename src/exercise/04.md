...
Managed State is managed by useState. <br /> Derived State doesn't need to be
managed by useState, use Variable instead. <br />Spread operator creates deep
copy of data if data is not nested
